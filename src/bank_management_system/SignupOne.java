...
public class SignupOne extends JFrame implements ActionListener{
    ...
    long random;
    JTextField nameJTextField,fnameJTextField,emailJTextField,addressJTextField,cityJTextField,stateJTextField,pinJTextField;
    JButton next;
    ...
    public void actionPerformed(ActionEvent e){
        ...
        String name = nameJTextField.getText();//setText
